...
export default function Header() {
  return (
    <header data-layer="Header" className="Header w-full h-16 lg:min-h-20 sm:w-full left-0 top-0 fixed z-50 bg-stone-50/80 shadow-[0px_1px_8px_0px_rgba(0,0,0,0.04)] backdrop-blur-md inline-flex flex-col justify-start items-start">
        <div data-layer="Container" className="Container w-full h-full max-w-[1280px] p-3.5 sm:px-5 lg:px-10 gap-3 inline-flex justify-between items-center">
            <div data-layer="Container" className="Container size- flex justify-start items-center gap-2">
                ...
                <div data-layer="Text" className="Text justify-center text-zinc-900 text-xl font-semibold font-['Syne'] uppercase leading-6">NABILAH A.</div>
            </div>
            <HeaderNav />
            <div data-layer="Container" className="Container flex justify-start items-center gap-4">
                <a data-layer="Link" href="#contact" className="Link px-4 py-2 sm:px-6 sm:py-3 bg-black rounded-full flex justify-start items-center gap-2">
                    <div data-layer="Container" className="Container size- inline-flex flex-col justify-start items-start">
                        <div data-layer="Text" className="Text justify-center text-white text-base font-normal font-['Space_Grotesk'] leading-6">Let&apos;s Talk</div>
                    </div>
